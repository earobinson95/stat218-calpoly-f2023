...
**COMMON FINAL: MONDAY, DECEMBER 8TH AT 7:10PM - 10:00PM (Building 26 Room 104)**

**Finals Office Hours**

+ Monday 12/8 at 1:00 - 2:30pm
+ Wednesday 12/10 at 1:00 - 2:30pm

*Remember your project reports are due Wed. Dec 10 at 11:59pm*
...
+ 40% new material -- I would fully expect:
  + an ANOVA scenario
  + Regression scenario on there
+ 30% cumulative material -- I would fully expect:
  + some two-sample independent t-tests vs paired t-tests
+ 20% determine the appropriate statistical analysis (see practice at the bottom!)

*Who knows, maybe some practice problems will show up on the exam.*
...
+ You can go back to optional assignments (Lab 8 and HW Ch. 9) for review as well.
...
17.	The Women’s Health Initiative randomized post-menopausal women to one of two treatments: estrogen plus progesterone hormone therapy or a placebo control. They were interested in whether or not the women developed cancer over the next five years.
